$(function() {
    ...
    setTimeout(function() {
        ...
        //**** 日文改英文 ****/
        var weaponSkillMap = {
            "characters' ATK↑ (+)": ["assault", 0, 0.5],
            "characters' ATK↑ (++)": ["assault", 3, 0.5],
            "characters' ATK↑ (+++)": ["assault", 6, 0.5],
            // "characters' ATK↑ (++++)": ["assault", 10, 1],
            "characters ATK↑ (++++)": ["assault", 9, 0.7],
            "characters' Max HP↑ (+)": ["defender", 0, 0.5],
            "characters' Max HP↑ (++)": ["defender", 3, 0.5],
            "characters' Max HP↑ (+++)": ["defender", 6, 0.5],
            // "characters' Max HP↑ (++++) ": ["defender", 10, 1],
            "characters' Max HP↑ (++++)": ["defender", 9, 0.7],
            "ATK↑": ["ambition", 10, 1],
            "characters' ATK↑ commensurate to low HP (+)": ["pride", 0, 0.35, 11.4], //小：0.35×SLv+12*(1-HP/MHP)	浮动0%~11.4%
            "characters' ATK↑ commensurate to low HP (++)": ["pride", 0, 0.5, 11.4], //中：0.5×SLv+12*(1-HP/MHP)		浮动0%~11.4%
            "characters' ATK↑ commensurate to low HP (+++)": ["pride", 0, 0.5, 19],
            "characters' ATK↑ commensurate to left HP ratio (+)": ["vigoras", 0, 0],
            "characters' ATK↑ commensurate to left HP ratio (++)": ["vigoras", 1, 0],
            "characters' ATK↑ commensurate to left HP ratio (+++)": ["vigoras", 2, 0],
            ...
            "characters' Recovery↑ ＆ ATK↑ commensurate to high HP (+)": ["sprout", 0, 0, 4, 1],
            "characters' Recovery↑ ＆ ATK↑ commensurate to high HP (++)": ["sprout", 1, 0, 7, 1],
            "characters' Recovery↑ ＆ ATK↑ commensurate to high HP (+++)": ["sprout", 2, 0, 10, 1],
            ...
            "characters' ATK ＆ Critical rate↑ (+)": ["slug", 0, 0.5, 0, 0.5],
            "characters' ATK ＆ Critical rate↑ (++)": ["slug", 3, 0.5, 3, 0.5],
            "characters' ATK ＆ Critical rate↑ (+++)": ["slug", 6, 0.5, 6, 0.5],
            ...
            "characters' Critical rate↑ (+)": ["stinger", 0, 0.5],
            "characters' Critical rate↑ (++)": ["stinger", 3, 0.5],
            "characters' Critical rate↑ (+++)": ["stinger", 6, 0.5],
